...
<body>
	<div id="conIns" class="centerXY divCI">
		...
		<div id="sInscr" class="cttConIns">
			...
			<p class="pSinscr">DICOTI.COM évolue tous les jours pour vous offrir le service le plus pertinent en fonction de votre niveau, de vos intérêts, de vos motivations et de vos ambitions.</p>
			<p  class="pSinscr">Motivez-vous et apprenez maintenant !</p>
			<a href="./inscr.php ">
