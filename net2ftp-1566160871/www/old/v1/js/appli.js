...
document.getElementById('global_menu_bouton').addEventListener('click', function(){
	document.getElementById('global_menu').style.left = '0%';
	document.getElementById('global_menu_container').style.left = '0%';
},false);
document.getElementById('global_menu_container').addEventListener('click', function(){
	closeMenu();
},false);
